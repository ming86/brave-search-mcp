/**
 * Type definitions for the Brave Search API.
 * 
 * These types mirror the Brave Search MCP server implementation to ensure
 * 100% compatibility and feature parity.
 * 
 * Source: brave-search-mcp-server/src/tools/web/types.ts
 */

/**
 * Input parameters for the Brave Web Search tool.
 * This interface is used by the VS Code LM Tool implementation.
 */
export interface IBraveWebSearchParams {
  query: string;
  country?: string;
  search_lang?: string;
  ui_lang?: string;
  ...
  spellcheck?: boolean;
  result_filter?: Array<'discussions' | 'faq' | 'infobox' | 'news' | 'query' | 'summarizer' | 'videos' | 'web' | 'locations' | 'rich'>;
  goggles?: string[];
...
// Formatted result types for LLM consumption
